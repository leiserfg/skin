...
exclusives_group.add_argument('-l', '--list', action='store_true', help='List all templates')
exclusives_group.add_argument('-b', '--bash', action='store_true', help='Bash Completion')
exclusives_group.add_argument('-z', '--zsh', action='store_true', help='Zsh Completion')
...
def autocomplete():
    ...
    if current.startswith('-'):
        ...
        print ' '.join(t for templates in _args if t.startswith(current))
